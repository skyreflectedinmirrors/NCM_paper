...
\end{equation}
This estimate allows for direct comparison of the error in forward or reverse ROPs to the magnitude of the net ROP itself, if they are of similar magnitude the error in net ROP will be large.
...
\multicolumn{1}{l}{GRI-Mech.~3.0\cite{smith_gri-mech_30}}  & 3.07e-8 & 5.90e-8 & 1.21e0 & 1.29e0 & 2.84e0 & 2.64e4 \\
\multicolumn{1}{l}{USC-Mech II\cite{Wang:2007}}  & 1.07e-7 & 1.37e-7 & 2.39e0 & 2.27e0 & 1.44e2 & 3.22e03 \\
