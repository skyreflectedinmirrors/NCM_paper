...
\end{equation}
If this estimate is near \SI{100}{\percent}, it indicates that the maximum error in forward or reverse ROPs are of a similar magnitude to the net ROP, hence the error in net ROP is expected be large in this case.
