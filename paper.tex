...
\end{equation}
This estimate allows for direct comparison of the error in forward or reverse ROPs to the net ROP, if they are of similar magnitude the error in net ROP will be large.
...
\multicolumn{1}{l}{GRI-Mech.~3.0\cite{smith_gri-mech_30}}  & 3.07e-8 & 5.90e-8 & 1.21e0 & 1.29e90 & 2.84e0 & 2.64e4 \\
